...
The data folder contains the SEED_rep_primary_iowa_county_2016.csv and the EMPTY_rep_primary_iowa_county_2016.csv.
The SEED data file contains made up numbers. The EMPTY file shows NA instead of votes per candidate and county.
...
Next to the map, the visualization also calculates totals and percentages shown in the tooltips for the map and the table below it.
...
##Conclusion
In this short tutorial, we have discussed the following:   
- How to embed the data visualization as an iframe   
- How to download, unzip and run the data visualization locally or on your own remote server       
...
Let us know when you have published the results of the Iowa Caucus 2016 on your own website.     
