...
If you have Firefox however, your file should open in the browser and work immediately.   
...
If you upload the unzipped bundle to any remote server, you can open the index.html with any modern browser.

So now that you have the data visualization up and running on your server, let us explain the important parts: the map, the data and the visualization.
