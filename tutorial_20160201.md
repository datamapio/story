...
We use mainly <a href="http://d3js.org/">D3</a> for our visualization. D3 stands for Data Driven Documents and is a JavaScript library for visualizing data with HTML, SVG, and CSS. D3 gives you the utmost flexibility for any data visualization.

Loading Files
Open the index.html to see what is happening. To understand how we load the map and the data, look at queue() (=> see <a href="https://github.com/d3/d3-queue">d3-queue</a>) in the javascript:
